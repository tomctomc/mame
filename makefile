...
$(PROJECTDIR)/$(MAKETYPE)-linux/Makefile: makefile $(SCRIPTS) $(GENIE)
	...
	mkdir -p /z/build/linux64/emulators/mame/build/linux_gcc/obj/x64/Release/src/mame
	mkdir -p /z/build/linux64/emulators/mame/build/linux_gcc/obj/x64/Debug/src/mame
